...
The spatial data and initial occurrence dataset used by these scripts are too large to be hosted on GitHub. They are permanently archived and freely available on Zenodo at: ....
